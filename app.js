document.addEventListener('DOMContentLoaded', () => {
  ...
  squares.forEach((square, i) => {
    ...
    square.onclick = function () {
      //if the square bwlow your current square is taken, you can go on top of it
  ...
  function checkBoard() {
    //make const that shows all winning possible Arrays
    const winningArrays = [
      [0, 1, 2, 3],
      [41, 40, 39, 38],
      [7, 8, 9, 10],
    ...
    //now take the 4 values in each winningArrays and plug thme into the squares
    winningArrays.forEach((w, i) => {
      ...
      if (
        ...
        result.innerHTML = 'Playey One Wins';
        //now check to see if they all hace the class name of player-two
      } else if (
        ...
        //if they do, player-one is the winner
        result.innerHTML = 'Playey Two Wins';
      }
    });
  }
